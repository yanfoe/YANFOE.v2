// --------------------------------------------------------------------------------------------------------------------
// <copyright company="The YANFOE Project" file="TVRenameFactory.cs">
...
namespace YANFOE.Factories.Renamer
{
    ...
    /// <summary>
    ///   The TV rename factory.
    /// </summary>
    public static class TVRenameFactory
    {
        #region Constructors and Destructors

        /// <summary>
        ///   Initializes static members of the <see cref="TVRenameFactory" /> class.
        /// </summary>
        static TVRenameFactory()
        {
        ...
        /// </summary>
        /// <value> The episode name template. </value>
                ...
                if (File.Exists(possibleFileName))
                {
                    ...
                    catch
                    {
                        Log.WriteToLog(
                            ...
                            0, 
                            "Could not rename", 
                            possibleFileName + " -> " + filePath + Path.DirectorySeparatorChar + renameTo + subExt);
                    }
                }
            }
        ...
        public static string RenameEpisode(Episode episode)
        {
            ...
            bool doRename;
            bool dummy = false;
            var episodesContaining = new List<Episode>();

            if (episode != null && episode.ProductionCode == "dummy")
            {
                dummy = true;
                seriesName = "Star Trek: Deep Space Nine";
                episode = new Episode { EpisodeNumber = 5, EpisodeName = "Cardassians", SeasonNumber = 2 };
                var ep2 = new Episode { EpisodeNumber = 6, EpisodeName = "Cardassians2", SeasonNumber = 2 };
                var ep3 = new Episode { EpisodeNumber = 7, EpisodeName = "Cardassians3", SeasonNumber = 2 };
            ...
            {
                episodeTemplate = episodeTemplate.Replace(MultiEpisodeFileTemplate, EpisodeMultiTemplate.Contains(EpisodeNumber1Template) ? episode1 : episode2);
            }
