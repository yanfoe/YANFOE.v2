// --------------------------------------------------------------------------------------------------------------------
// <copyright company="The YANFOE Project" file="YRegex.cs">
...
namespace YANFOE.Tools
{
    ...
    public static class YRegex
    {
        ...
        /// </summary>
        /// <param name="text">
        /// The string for which the search will take place in. 
        /// </param>
        /// <param name="begin">
        /// The start string 
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// Value between to input strings 
        /// </returns>
        ...
        /// The string for which the search will take place in. 
        /// </param>
        /// <param name="includeBeginning">
        /// Include the begin value in the returned string 
        /// </param>
        /// <param name="includeEnd">
        /// Include the end value in the returned string 
        /// </param>
        /// <returns>
        /// Returns value between string 
        /// </returns>
        public static string[] GetValueBetween(
            string begin, string end, string text, bool includeBeginning, bool includeEnd)
        {
        ...
        /// </param>
        /// <param name="value">
        /// The value to run the regex against 
        /// </param>
        /// <param name="group">
        /// The group to return 
        /// </param>
        /// <param name="clean">
        /// if set to <c>true</c> the return value is cleaned. 
        /// </param>
        /// <returns>
        /// The <see cref="string"/>.
        /// </returns>
        ...
        /// </returns>
        public static ThreadedBindingList<string> MatchDelimitedToList(
            string regex, string html, string group, char delimiter, bool clean = false)
        {
            ...
            try
            {
                ...
                return split.ToBindingStringList().ToThreadedBindingList();
            }
            catch (Exception ex)
            {
                Log.WriteToLog(LogSeverity.Error, LoggerName.GeneralLog, logCatagory, ex.Message);
        ...
        /// The <see cref="ThreadedBindingList"/>.
        /// </returns>
        public static ThreadedBindingList<string> MatchFilteredByList(
            string regex, string value, string group, IEnumerable<string> filters, bool clean = false)
        {
            var match = Match(regex, value, group, clean);
            return (from f in filters where match.Contains(f) select match).ToThreadedBindingList();
        }

        /// <summary>
        /// The match to date time.
        /// </summary>
        /// <param name="regex">
        /// The regex.
        /// </param>
        ...
        /// The <see cref="DateTime"/>.
        /// </returns>
        public static DateTime MatchToDateTime(
            string regex, string html, string day, string month, string year, Dictionary<string, int> monthString)
        {
            var match = Regex.Match(html, regex);
        ...
        /// The <see cref="ThreadedBindingList"/>.
        /// </returns>
        public static ThreadedBindingList<PersonModel> MatchToPersonList(
            string regex, string value, string group, char delimiter, bool clean = false)
        {
        ...
        /// if set to <c>true</c> the return value is cleaned. 
        /// </param>
        /// <param name="returnDelimiter">
        /// The return delimiter. 
        /// </param>
        /// <returns>
        /// The <see cref="string"/>.
        /// </returns>
        public static string Matches(
            string regex, string value, string group, bool clean = false, string returnDelimiter = ",")
        {
        ...
        /// </param>
        /// <param name="clean">
        /// if set to <c>true</c> [clean]. 
        /// </param>
        /// <returns>
        /// The <see cref="Dictionary"/>.
        /// </returns>
        public static Dictionary<string, string> Matches(
            string regex, string value, string groupValue, string groupKey, bool clean)
        {
            ...
            try
            {
                ...
                foreach (Match match in matchCollection)
                {
                    ...
                    {
                        matches.Add(
                            Clean.Text.FullClean(match.Groups[groupValue].Value), 
        ...
        /// The <see cref="ThreadedBindingList"/>.
        /// </returns>
        public static ThreadedBindingList<string> MatchesToList(
            string regex, string html, string group, bool clean = false)
        {
            ...
            try
            {
                ...
                var matches = new ThreadedBindingList<string>();
                foreach (Match match in matchCollection)
                {
        ...
        /// <summary>
        /// The matches to list filter by list.
        /// </summary>
        /// <param name="regex">
        /// The regex.
        /// </param>
        ...
        /// The <see cref="ThreadedBindingList"/>.
        /// </returns>
        public static ThreadedBindingList<string> MatchesToListFilterByList(
            string regex, string html, string group, ThreadedBindingList<string> filter, bool clean = false)
        {
            var matches = MatchesToList(regex, html, group, clean);
            return matches.Where(filter.Contains).ToThreadedBindingList();
        }

        /// <summary>
        /// The matches to person list.
        /// </summary>
        /// <param name="regex">
        /// The regex.
        /// </param>
        ...
        /// The <see cref="ThreadedBindingList"/>.
        /// </returns>
        public static ThreadedBindingList<PersonModel> MatchesToPersonList(
            string regex, string html, string group, bool clean = false)
        {
            var matches = MatchesToList(regex, html, group, clean);
            return matches.Select(m => new PersonModel(m.Trim())).ToThreadedBindingList();
        }
        ...
        /// </returns>
        public static ThreadedBindingList<PersonModel> MatchesToPersonList(
            string regex, string matchHhtml, string matchName, string role = null, string imageurl = null)
        {
            var personList = new ThreadedBindingList<PersonModel>();
