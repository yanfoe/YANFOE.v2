// --------------------------------------------------------------------------------------------------------------------
// <copyright company="The YANFOE Project" file="Text.cs">
...
namespace YANFOE.Tools.Clean
{
    ...
    public static class Text
    {
        ...
        private static readonly string[,] MatrixConversion =
            {
                ...
                , { "&#250;", "ú" }, { "&#251;", "û" }, { "&#252;", "ü" }
                , { "&#253;", "ý" }, { "&#254;", "þ" }, { "&#255;", "ÿ" }
                , { "%C3%A4", "ä" }, { "%C3%B6", "ö" }, { "%C3%BC", "ü" }
                , { "%C3%9F", "ß" }, { "%C3%84", "Ä" }, { "%C3%96", "Ö" }
                , { "%C3%9C", "Ü" }, { "%C3%80", "À" }, { "%C3%82", "Â" }
                , { "%C3%A0", "à" }, { "%C3%A2", "â" }, { "%C3%A7", "ç" }
                , { "%C3%A8", "è" }, { "%C3%8B", "Ë" }, { "%C3%AA", "ê" }
                , { "%C3%A9", "é" }, { "%C3%AB", "ë" }, { "%C3%89", "É" }
                , { "%C3%88", "È" }, { "%C3%8F", "Ï" }, { "%C3%AF", "ï" }
                , { "%C3%AE", "î" }, { "%C3%B1", "ñ" }, { "%C3%B4", "ô" }
                , { "%C3%BB", "û" }, { "%C3%B9", "ù" }, { "%C3%99", "Ù" }
            };
        ...
        /// </summary>
        /// <param name="text">
        /// The string for which all all HTML tags will be removed. 
        /// </param>
        /// <returns>
        /// String with all HTML removed 
        /// </returns>
        ...
        /// </summary>
        /// <param name="text">
        /// String for which replacements will be made. 
        /// </param>
        /// <returns>
