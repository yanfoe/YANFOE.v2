// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Impawards.cs" company="The YANFOE Project">
...
namespace YANFOE.Scrapers.Movie
{
    ...
    public class Impawards : ScraperMovieBase, IMovieScraper
    {
        ...
        /// Extracts the poster.
        /// </summary>
        /// <param name="id">The thread MovieUniqueId</param>
        /// <returns>The return URL</returns>
        private string ExtractPoster(string id)
        {
            try
            {
                var result = Downloader.ProcessDownload(this.Urls["main"] + id, DownloadType.Html, Section.Movies).RemoveCharacterReturn();
