// --------------------------------------------------------------------------------------------------------------------
// <copyright company="The YANFOE Project" file="AppleTrailerSearchModel.cs">
...
namespace YANFOE.Scrapers.Movie.Models.AppleTrailers
{
    ...
    [Serializable]
    public class AppleTrailerSearchModel : ModelBase, IMyDataErrorInfo
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="AppleTrailerSearchModel"/> class. 
        ///   Initializes a new instance of the <see cref="MovieModel"/> class.
        /// </summary>
        public AppleTrailerSearchModel()
        {
            this.error = false;
            this.results = new ThreadedBindingList<AppleTrailerResultsModel>();
        }
        ...
        /// </summary>
        public ThreadedBindingList<AppleTrailerResultsModel> results { get; set; }
