// --------------------------------------------------------------------------------------------------------------------
// <copyright company="The YANFOE Project" file="MediaCollectionModel.cs">
...
namespace YANFOE.Models.GeneralModels
{
    ...
    public sealed class MediaCollection
    {
        ...
        {
            this.File = new ThreadedBindingList<MediaModel>();
        }
        ...
        ///   Gets or sets File.
        /// </summary>
        public ThreadedBindingList<MediaModel> File { get; set; }
